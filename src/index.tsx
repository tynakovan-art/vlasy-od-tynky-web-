    ...
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <section id="hero" className="relative z-10">
        <div className="relative mx-auto max-w-6xl px-6 pt-12 pb-16 md:pt-16 md:pb-24 grid md:grid-cols-2 gap-10 items-center">
          {/* Levý sloupec – nadpisy s menší mezerou */}
          <div>
            <motion.div
            ...
            >
              ...
              <div className="text-2xl md:text-3xl font-medium -mt-1.5">Mladá Boleslav</div>
            </motion.div>
          ...
          {/* Pravý sloupec – karta s textovým logem + odkazy */}
          ...
          <div className="relative mt-6 overflow-hidden rounded-2xl border bg-white">
            ...
            >
              <SmartImage
                srcs={LOGO_SILUETY}
                alt=""
                className="max-w-[60%] md:max-w-[40%] h-auto scale-110 blur-[1.5px] select-none pointer-events-none"
      ...
      <section id="kontakt" className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-16 grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="w-full">
            <div className="rounded-2xl border bg-white/70 backdrop-blur overflow-hidden shadow">
              <iframe
      ...
      {/* DĚKOVACÍ KARTA – užší a s menším (ale sytějším) vodoznakem textového loga */}
        ...
        <div className="mx-auto max-w-6xl px-6 pb-16">
          <div className="relative max-w-md md:max-w-lg mx-auto">
            ...
            <div className="relative rounded-[2rem] border bg-white/70 backdrop-blur py-24 px-10 shadow-xl text-center overflow-hidden">
              {/* Vodoznak menší a o kousíček sytější */}
              <div
                aria-hidden
              ...
              >
                <SmartImage
                  srcs={LOGO_TEXT}
                  alt=""
                  className="max-w-[50%] h-auto scale-110 blur-[1.2px] select-none pointer-events-none"
