...
/** Obrázek s fallbackem a více cestami (kvůli diakritice / mezerám) */
function SmartImage({
  srcs,
  alt,
  className,
...
/** ---------- CESTY K NOVÝM LOGŮM (s fallbacky) ---------- */
/** Nové „bez“ logo – používáme ho jako transparentní i jako textové */
const LOGO_BEZ = [
  "/kadeřnictví - logo bez .png",
  "/kadernictvi - logo bez .png",
  "/kadernictvi-logo-bez.png",
];

/** Nové siluety: „Mladá Boleslav - logo.png“ */
const LOGO_SILUETY = [
  "/Mladá Boleslav - logo.png",
  "/Mlada Boleslav - logo.png",
  "/mlada-boleslav-logo.png",
];
...
/** Google Maps – odkaz + EMBED (funguje bez API klíče) */
    ...
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <header className="sticky top-0 z-20 bg-white/80 backdrop-blur border-b">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
          ...
          <a href="#hero" className="flex items-center gap-3">
            <SmartImage
              srcs={LOGO_SILUETY}
              alt="Vlasy od Týnky – logo siluety"
      ...
      <section id="hero" className="relative z-10">
        <div className="relative mx-auto max-w-6xl px-6 pt-12 pb-16 md:pt-16 md:pb-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          {/* Pravý sloupec – karta s PRŮHLEDNÝM (bez) logem */}
          <div className="md:justify-self-end relative">
            ...
            <div className="relative rounded-[2rem] border bg-white/70 backdrop-blur p-8 shadow-xl text-center overflow-hidden">
              <SmartImage
                srcs={LOGO_BEZ}
                alt="Vlasy od Týnky – transparentní logo"
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border bg-white/70 p-6">
              ...
              <p className="mt-2 text-sm text-slate-600">Prosvětlení a struktura účesu pomocí jemných pramínků – přirozený výsledek.</p>
            </div>
            <div className="rounded-2xl border bg-white/70 p-6">
      ...
      <section id="o-mne" className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
          ...
          <p className="mt-4 text-slate-700 leading-relaxed">
            ...
            odcházel spokojený a s účesem, který mu sedí. Nabízím dámské, pánské i dětské služby s důrazem
            na individuální přístup a příjemnou atmosféru.
          </p>
          <p className="mt-2 text-sm text-slate-500">
            Pracuji s <strong>Echosline</strong> – profesionální italskou vlasovou kosmetikou se šetrným složením a skvělými výsledky.
          </p>
        </div>
      </section>
      ...
      <section id="cenik" className="relative z-10">
        <div className="relative mx-auto max-w-6xl px-6 py-16">
          ...
          <p className="text-xs text-neutral-500 mb-4">
            Akce –20 % platí pro všechny zákazníky po celý říjen 2025. Přeškrtnuté částky jsou původní ceny, zvýrazněné jsou akční.
          </p>

          <div className="relative mt-6 overflow-hidden rounded-2xl border bg-white">
            {/* Vodoznak uvnitř karty (logo siluet) */}
            <div
              aria-hidden
            ...
            >
              <SmartImage
                srcs={LOGO_SILUETY}
                alt="Vlasy od Týnky – vodoznak ceník"
            ...
            <div className="relative" style={{ zIndex: 1 }}>
              ...
              <div className="p-6 border-b">
                ...
                <ul className="mt-3 text-sm text-slate-700 space-y-4">
                  <li>
                    <div className="flex justify-between font-medium"><span>Dámský střih</span><PriceStrike oldLabel="od 650 Kč" newLabel="od 520 Kč" /></div>
                    <div className="text-xs text-slate-500">Konzultace, mytí, střih, foukaná, styling.</div>
                  </li>
                  <li>
                    <div className="flex justify-between font-medium"><span>Pánský střih</span><PriceStrike oldLabel="od 350 Kč" newLabel="od 280 Kč" /></div>
                    <div className="text-xs text-slate-500">Střih nůžkami i strojkem.</div>
                  </li>
                  <li>
                    <div className="flex justify-between font-medium"><span>Dětský střih (do 12 let)</span><PriceStrike oldLabel="od 250 Kč" newLabel="od 200 Kč" /></div>
                    <div className="text-xs text-slate-500">Rychlý střih přizpůsobený dětem.</div>
                  </li>
                  <li>
                    <div className="flex justify-between font-medium"><span>Foukaná / styling bez střihu</span><PriceStrike oldLabel="od 400 Kč" newLabel="od 320 Kč" /></div>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-6 border-b">
                ...
                <ul className="mt-3 text-sm text-slate-700 space-y-4">
                  <li>
                    <div className="flex justify-between font-medium"><span>Barvení / tónování</span><PriceStrike oldLabel="od 1 350 Kč" newLabel="od 1 080 Kč" /></div>
                    <div className="text-xs text-slate-500">Kompletní barvení nebo tónování, včetně střihu a foukané.</div>
                  </li>
                  <li>
                    <div className="flex justify-between font-medium"><span>Melír klasický</span><PriceStrike oldLabel="od 1 850 Kč" newLabel="od 1 480 Kč" /></div>
                    <div className="text-xs text-slate-500">Melírování pramenů, střih a styling.</div>
                  </li>
                  <li>
                    <div className="flex justify-between font-medium"><span>Mikromelír + tónování</span><PriceStrike oldLabel="od 2 050 Kč" newLabel="od 1 640 Kč" /></div>
                    <div className="text-xs text-slate-500">Jemné prosvětlení s doladěním odstínu.</div>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-6">
                ...
                <ul className="mt-3 text-sm text-slate-700 space-y-4">
                  <li>
                    <div className="flex justify-between font-medium"><span>B.Pur hloubkové čištění</span><PriceStrike oldLabel="+230 Kč" newLabel="+184 Kč" /></div>
                    <div className="text-xs text-slate-500">Detox vlasů a pokožky.</div>
                  </li>
                  <li>
                    <div className="flex justify-between font-medium"><span>Ki-Power Veg rekonstrukce</span><PriceStrike oldLabel="+260 Kč" newLabel="+208 Kč" /></div>
                    <div className="text-xs text-slate-500">Intenzivní výživa po barvení a melíru.</div>
                  </li>
                </ul>
              </div>

              <div className="p-4 text-xs text-slate-500 border-t">
                Uvedené ceny jsou orientační a závisí na délce/hustotě vlasů a spotřebě materiálu.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 grid md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-3 text-slate-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <a href={MAP_LINK_URL} target="_blank" rel="noopener noreferrer" className="font-medium hover:underline">
                    {ADDRESS_LINE1}
                  </a>
          ...
          <div className="md:justify-self-end w-full">
            <div className="relative max-w-md ml-auto w-full">
              <div className="overflow-hidden rounded-[2rem] border bg-white/70 backdrop-blur shadow-xl">
                <iframe
      ...
      {/* PODĚKOVÁNÍ – úzký pruh uprostřed, s vodoznakem „bez“ loga, lehce silnější */}
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="relative mx-auto w-full max-w-xl">
            <div
              ...
              style={{ background: "linear-gradient(135deg,#6aa2ff,#b57bff,#ff7ad6)" }}
            />
            <div className="relative rounded-[2rem] border bg-white/75 backdrop-blur py-24 px-12 shadow-xl text-center overflow-hidden">
              {/* vodoznak – sytější */}
              <div
                aria-hidden
                ...
                style={{
                  WebkitMaskImage:
                    "radial-gradient(70% 70% at 50% 50%, rgba(0,0,0,1) 60%, rgba(0,0,0,0) 100%)",
                  maskImage:
                    "radial-gradient(70% 70% at 50% 50%, rgba(0,0,0,1) 60%, rgba(0,0,0,0) 100%)",
                }}
              >
      ...
      {/* FOOTER – větší „bez“ logo */}
      <footer className="relative z-10 border-t bg-white/60 backdrop-blur mt-12">
