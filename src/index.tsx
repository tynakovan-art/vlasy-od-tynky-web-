...
export default function Site() {
  ...
  useEffect(() => {
    const checks = [
      ...
      { name: "sec#hero", pass: !!document.getElementById("hero") },
      { name: "sec#cenik", pass: !!document.getElementById("cenik") },
      { name: "sec#kontakt", pass: !!document.getElementById("kontakt") },
      { name: "tel link", pass: !!document.querySelector('a[href^="tel:"]') },
    ];
    checks.forEach((t) => console.assert(t.pass, `Test fail: ${t.name}`));
  }, []);
